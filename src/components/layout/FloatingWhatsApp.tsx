      ...
      {show && (
        ...
        >
          ...
          <motion.div
            ...
            className="bg-white rounded-xl shadow-lg border border-slate-100 px-3 py-2 text-xs font-semibold text-slate-700 mb-1 whitespace-nowrap"
          >
            Telegram orqali yozing ✈️
          </motion.div>
          ...
          <div className="relative flex flex-col items-center gap-1">
            ...
            <button
              ...
              className="w-5 h-5 bg-slate-400 hover:bg-slate-500 rounded-full flex items-center justify-center transition-colors"
              aria-label="Yopish"
            >
